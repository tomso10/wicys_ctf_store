...
func (tu *TokenUpdate) SetType(t token.Type) *TokenUpdate {
	tu.mutation.SetType(t)
	return tu
}

// AddUserIDs adds the "user" edge to the User entity by IDs.
func (tu *TokenUpdate) AddUserIDs(ids ...int) *TokenUpdate {
	tu.mutation.AddUserIDs(ids...)
	return tu
}

// AddUser adds the "user" edges to the User entity.
func (tu *TokenUpdate) AddUser(u ...*User) *TokenUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (tu *TokenUpdate) RemoveUserIDs(ids ...int) *TokenUpdate {
	tu.mutation.RemoveUserIDs(ids...)
	return tu
}

// RemoveUser removes "user" edges to User entities.
func (tu *TokenUpdate) RemoveUser(u ...*User) *TokenUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// SetType sets the "type" field.
func (tuo *TokenUpdateOne) SetType(t token.Type) *TokenUpdateOne {
	tuo.mutation.SetType(t)
	return tuo
}

// AddUserIDs adds the "user" edge to the User entity by IDs.
func (tuo *TokenUpdateOne) AddUserIDs(ids ...int) *TokenUpdateOne {
	tuo.mutation.AddUserIDs(ids...)
	return tuo
}

// AddUser adds the "user" edges to the User entity.
func (tuo *TokenUpdateOne) AddUser(u ...*User) *TokenUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// RemoveUserIDs removes the "user" edge to User entities by IDs.
func (tuo *TokenUpdateOne) RemoveUserIDs(ids ...int) *TokenUpdateOne {
	tuo.mutation.RemoveUserIDs(ids...)
	return tuo
}

// RemoveUser removes "user" edges to User entities.
func (tuo *TokenUpdateOne) RemoveUser(u ...*User) *TokenUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
