...
func (tu *TransactionUpdate) SetInstructions(s string) *TransactionUpdate {
	tu.mutation.SetInstructions(s)
	return tu
}

// SetItemID sets the "item" edge to the Item entity by ID.
func (tu *TransactionUpdate) SetItemID(id int) *TransactionUpdate {
	tu.mutation.SetItemID(id)
	return tu
}

// SetItem sets the "item" edge to the Item entity.
func (tu *TransactionUpdate) SetItem(i *Item) *TransactionUpdate {
	return tu.SetItemID(i.ID)
}
...
func (tu *TransactionUpdate) ClearItem() *TransactionUpdate {
	tu.mutation.ClearItem()
	return tu
}
...
func (tu *TransactionUpdate) check() error {
	if _, ok := tu.mutation.ItemID(); tu.mutation.ItemCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Transaction.item"`)
	}
...
func (tu *TransactionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := tu.mutation.ItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   transaction.ItemTable,
...
// SetInstructions sets the "instructions" field.
func (tuo *TransactionUpdateOne) SetInstructions(s string) *TransactionUpdateOne {
	tuo.mutation.SetInstructions(s)
	return tuo
}

// SetItemID sets the "item" edge to the Item entity by ID.
func (tuo *TransactionUpdateOne) SetItemID(id int) *TransactionUpdateOne {
	tuo.mutation.SetItemID(id)
	return tuo
}

// SetItem sets the "item" edge to the Item entity.
func (tuo *TransactionUpdateOne) SetItem(i *Item) *TransactionUpdateOne {
	return tuo.SetItemID(i.ID)
}
...
// ClearItem clears the "item" edge to the Item entity.
func (tuo *TransactionUpdateOne) ClearItem() *TransactionUpdateOne {
	tuo.mutation.ClearItem()
	return tuo
}
...
func (tuo *TransactionUpdateOne) check() error {
	if _, ok := tuo.mutation.ItemID(); tuo.mutation.ItemCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Transaction.item"`)
	}
...
func (tuo *TransactionUpdateOne) sqlSave(ctx context.Context) (_node *Transaction, err error) {
	...
	if nodes := tuo.mutation.ItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   transaction.ItemTable,
